    ...
    <form class="max-w-md mx-auto">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search"
                ...
                placeholder="Search Post Title..." name="search" autofocus autocomplete="off" />
            <button type="submit"
        ...
        <div class="mt-4 grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            ...
            @empty
                <div>
                    ...
                    <a href="/blog" class="block text-blue-400 hover:underline">&laquo; Back to all blog</a>
                </div>
            @endforelse
        </div>
    </div>
