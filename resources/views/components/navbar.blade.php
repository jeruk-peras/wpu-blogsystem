 <nav class="bg-gray-800">
     ...
     <el-disclosure id="mobile-menu" hidden class="block md:hidden">
         <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <x-nav-link href="/" class="block" :current="request()->is('/')" >Home</x-nav-link>
            <x-nav-link href="/blog" class="block" :current="request()->is('blog')">Blog</x-nav-link>
            <x-nav-link href="/about" class="block" :current="request()->is('about')">About</x-nav-link>
            <x-nav-link href="/contact" class="block" :current="request()->is('contact')">Contact</x-nav-link>
         </div>
